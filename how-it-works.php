...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                ...
                <ul class="navbar-nav align-items-center me-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="how-it-works.php">
                            <?= __('how_it_works'); ?>
                        </a>
                    </li>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <!-- LANGUAGE DROPDOWN -->
                    <select class="lang-dropdown fw-bold text-success"
                            onchange="window.location.href=this.value;">

                        <option value="how-it-works.php?lang=en"
                            <?= ($current_lang === 'en') ? 'selected' : ''; ?>>
                            English
                        </option>

                        <option value="how-it-works.php?lang=kn"
                            <?= ($current_lang === 'kn') ? 'selected' : ''; ?>>
                            ಕನ್ನಡ (Kannada)
                        </option>

                        <option value="how-it-works.php?lang=hi"
    ...
    <div class="container my-5">
        ...
        <h3 class="fw-bold mb-4 text-center text-dark">
            ...
            <i class="fa-solid fa-hand-holding-hand text-success me-2"></i>
